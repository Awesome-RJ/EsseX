...
from thebot import dankbot, ALLOWED_USERS
...
@dankbot.on_message(filters.user(ALLOWED_USERS) & filters.command("stats", prefixes='/'))
...
@dankbot.on_message(~filters.me & filters.user(ALLOWED_USERS) & filters.command("chats", prefixes='/'))
...
@dankbot.on_message(filters.all & filters.group)
